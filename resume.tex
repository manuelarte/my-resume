...
\makeheading{\includegraphics[height=1.3in, width=1.1in]{profile.jpg}{Manuel Doncel Martos, 40}}
...
\section{About me}
Results-driven Tech Lead with 15+ years of experience building production-ready software in Java and Go. 
Proven track record of delivering complex projects from concept to deployment. Known for a hands-on, can-do mentality—whether tackling technical challenges, mentoring teams, or contributing to open source. Passionate about writing clean, maintainable code and continuously expanding my skills through real-world projects.
