...
\makeheading{\includegraphics[height=1.3in, width=1.1in]{profile.jpg}{Manuel Doncel Martos, 34}}
...
%
%\begin{innerlist}
   % \item Carta de recomendación de la empresa \href{http://www.laprimera.net/}{\textbf{LaPrimera.net}}
    %\item Fotocopia del título de Ingeniero Técnico de Telecomunicación
%\end{innerlist}
